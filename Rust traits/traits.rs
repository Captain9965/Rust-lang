/*
    A trait defines shared functionality for multiple types, promoting type safety, preventing errors at compile time, 
    and acts like interfaces in other languages.
